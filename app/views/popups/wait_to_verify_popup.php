<link rel="stylesheet" href="<?php echo URLROOT; ?>/css/popups/wait_to_verify_popup.css">
<div class="popup-container">
    <div class="popup" id="popup-verify">
...
<script src="<?php echo URLROOT; ?>/public/js/login/wait_to_verify_popup.js"></script>