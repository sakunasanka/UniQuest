...
<div class="popup-container">
    <div class="popup" id="popup-1">
        ...
        <div class="content">
            <button class="close-btn" onclick="togglePopup1()"><i class="fa fa-times"></i></button><button class="close-btn" onclick="toggleMoreReviews()"><i class="fa fa-times"></i></button>
            <p class="popup-text red-text">Are you sure you want to deactivate this account?</p>
            <div class="btn-container">
                <a href="#" class="no-btn" onclick="togglePopup1()">No</a>
...
<div class="popup-container">
    <div class="popup" id="popup-2">
        ...
        <div class="content">
            ...
            <p class="popup-text">Are you sure you want to activate this account?</p>
            <div class="btn-container">
                <a href="#" class="no-btn" onclick="togglePopup2()">No</a>
