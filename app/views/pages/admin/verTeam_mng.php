                        ...
                        <tr>
                            ...
                            <?php if ($user->Status == 'Active') : ?>
                                ...
                                <td class="action">
                                    ...
                                    <span class="material-symbols-outlined action-btn deactivate" onclick="window.location.href='<?php echo URLROOT; ?>/admin/user_deactivate/<?php echo $user->UserID; ?>'">
                                        person_remove
                                    </span>
                                </td>
                            <?php else : ?>
                                ...
                                <td class="action">
                                    ...
                                    <span class="material-symbols-outlined action-btn activate" onclick="window.location.href='<?php echo URLROOT; ?>/admin/user_activate/<?php echo $user->UserID; ?>'">
                                        person_add
                                    </span>
                                </td>
                            <?php endif; ?>
