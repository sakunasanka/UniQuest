                            ...
                            <tr>
                                ...
                                <?php if ($message->sender_role == 'Company') : ?>
                                    <button id="openPopupBtn" class="open-btn-2 material-symbols-outlined action-btn view" 
                                        onclick="window.location.href='<?php echo URLROOT; ?>/admin/messages_com/<?php echo $message->sender_id; ?>'">
                                        preview
                                    </button>
                                    <?php elseif ($message->receiver_role == 'Student'):?>
                                        <button id="openPopupBtn" class="open-btn-2 material-symbols-outlined action-btn view" 
                                        onclick="window.location.href='<?php echo URLROOT; ?>/admin/messages_com/<?php echo $message->receiver_id; ?>'">
                                        preview
                                    </button>
                                <?php endif; ?>
