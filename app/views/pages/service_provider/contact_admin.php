...
<?php require APPROOT . '/views/components/serviceSidePanel.php'; ?>
    ...
    <!-- Remove these popup-related elements -->
...
<div class="chat-container">
    <div class="chat-header">
        <h2>Chat with 
            <?php 
            if ($_SESSION['user_role'] == 'Admin' || $_SESSION['user_role'] == 'VT-Member' || $_SESSION['user_role'] == 'Student' || $_SESSION['user_role'] == 'Company') {
        ...
        <!-- Remove the close button since it's not a popup anymore -->
