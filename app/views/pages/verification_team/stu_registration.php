    ...
    <div class="vreg_form-container">
        ...
        <form action="submit_registration.php" method="POST">
            ...
            <div class="vreg_form-group">
                ...
                <input type="text" id="name" name="name" class="vreg_input" required>
            </div>

            <!-- NIC Field -->
            <div class="vreg_form-group vreg_nic-container">
                <label for="nic" class="vreg_label">NIC</label>
                <input type="text" id="nic1" name="nic1" class="vreg_input" placeholder="NIC Part 1" required>
                <input type="text" id="nic2" name="nic2" class="vreg_input" placeholder="NIC Part 2" required>
            </div>

            <!-- Email Field -->
            <div class="vreg_form-group">
                <label for="email" class="vreg_label">Email</label>
                <input type="email" id="email" name="email" class="vreg_input" required>
            </div>

            <!-- Mobile Number Field -->
            <div class="vreg_form-group">
                <label for="mobile" class="vreg_label">Mobile No:</label>
                <input type="text" id="mobile" name="mobile" class="vreg_input" required>
            </div>

            <!-- University Field -->
            <div class="vreg_form-group">
                <label for="university" class="vreg_label">University</label>
                <input type="text" id="university" name="university" class="vreg_input" required>
            </div>
