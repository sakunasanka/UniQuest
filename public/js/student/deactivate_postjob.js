...
function showdeletereviewconfirm(postID) {
    ...
    const deletereviewForm = document.getElementById("delete-post-form");
    deletereviewForm.action = `http://localhost/UniQuest/service_provider/deactivate/${postID}`;
}

// Function to close the deactivate review confirmation popup
